...
from titanbot.tt2_py.bot.tt2.core.maps import STATS_COORDS, STAGE_COORDS, CLAN_COORDS, ARTIFACT_TIER_MAP
from titanbot.tt2_py.bot.tt2.core.constants import (
    STATS_JSON_TEMPLATE, STATS_GAME_STAT_KEYS, STATS_BOT_STAT_KEYS, LOGGER_FILE_NAME, STATS_DATE_FMT,
)
from titanbot.tt2_py.bot.tt2.core.utilities import convert, diff
...
class Stats:
    ...
    def parse_artifacts(self):
        ...
        """
        from titanbot.tt2_py.bot.tt2.core.maps import ARTIFACT_TIER_MAP, ARTIFACT_MAP, GAME_LOCS, IMAGES
        from titanbot.tt2_py.bot.tt2.core.utilities import sleep, drag_mouse
