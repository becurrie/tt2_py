...
from titanbot.tt2_py.bot.tt2.core.constants import STATS_GAME_STAT_KEYS, STATS_BOT_STAT_KEYS
from titanbot.tt2_py.bot.tests.maps import IMAGES as TEST_IMAGES
